...
const commonStyles =
  "min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-sm font-light text-white cursor-pointer";
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <div className="grid sm:grid-cols-3 grid-cols-3 w-full mt-10">
            ...
            <div className={`rounded-br-2xl ${commonStyles}`}>Blobkchain</div>
          </div>
        </div>
